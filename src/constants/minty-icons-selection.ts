...
export const MINTY_SVGS: MintyIconData[] = [
  // Money & Finance
  { name: "wallet-outline", keywords: ["money", "cash", "payment"] },
  ...
  { name: "cash-banknote", keywords: ["money", "payment", "dollar"] },
  {
    ...
    keywords: ["income", "deposit", "add money"],
  },
  { name: "currency-dollar-outline", keywords: ["dollar", "money", "usd"] },
  { name: "coin-pound", keywords: ["pound", "money", "gbp"] },
  { name: "pig-money-outline", keywords: ["savings", "save", "piggy bank"] },
  { name: "pig", keywords: ["savings", "piggy", "money"] },
  {
    name: "percentage-outline",
    keywords: ["discount", "tax", "rate", "interest"],
  },
  ...
  { name: "chart-bar-outline", keywords: ["graph", "analytics", "statistics"] },
  { name: "chart-pie", keywords: ["graph", "analytics", "distribution"] },
  { name: "chart-dots", keywords: ["scatter", "data", "analytics"] },
  { name: "trending-up-outline", keywords: ["growth", "increase", "profit"] },
  { name: "trending-down-outline", keywords: ["loss", "decrease", "decline"] },

  // Tags & Labels
  { name: "tag", keywords: ["label", "category", "price"] },
  { name: "tags", keywords: ["labels", "categories", "tags"] },
  { name: "tag-plus-outline", keywords: ["new tag", "add label", "category"] },
  ...
  { name: "map-outline", keywords: ["navigation", "directions", "travel"] },
  ...
  { name: "lock", keywords: ["security", "secure", "protected"] },
  {
    ...
    keywords: ["biometric", "secure", "identity"],
  },
  {
  ...
  { name: "user-outline", keywords: ["person", "account", "profile"] },
  { name: "heart", keywords: ["health", "love", "wellness"] },
  {
    name: "activity-outline",
    keywords: ["pulse", "activity-outline", "heartbeat"],
  },

  // Places & Buildings
  { name: "building-outline", keywords: ["office", "work", "corporate"] },
  ...
  {
    name: "checks-outline",
    keywords: ["verified", "double check", "confirmed"],
  },

  // Categories & Shapes
  { name: "category-outline", keywords: ["group", "type", "category-outline"] },
  { name: "category-2-outline", keywords: ["group", "type", "category"] },
  {
    name: "category-plus-outline",
    keywords: ["new category", "add group", "type"],
  },
  ...
  { name: "calendar-event", keywords: ["appointment", "meeting", "event"] },
  {
    ...
    keywords: ["recurring", "schedule", "repeat"],
  },
  ...
  { name: "clock-bolt-outline", keywords: ["fast", "time", "quick"] },
  { name: "clock-hour-4", keywords: ["time", "deadline", "schedule"] },
  { name: "anchor-outline", keywords: ["maritime", "stable", "fixed"] },
  ...
  { name: "hash-outline", keywords: ["number", "tag", "social"] },
  { name: "affiliate-outline", keywords: ["referral", "partner", "network"] },
  { name: "adjustments", keywords: ["settings", "tune", "configure"] },
  { name: "scale-outline", keywords: ["balance", "justice", "weight"] },
  ...
  { name: "world-pin-outline", keywords: ["global", "world", "location"] },
  ...
  // Food & Drink
  { name: "coffee-outline", keywords: ["coffee-outline", "cafe", "drink"] },
  ...
  {
    name: "dice-outline",
    keywords: ["gaming", "board games", "chance", "fun"],
  },
  {
    name: "wand-outline",
    keywords: ["magic", "creative", "special", "entertainment"],
  },
  ...
  {
    name: "coins-outline",
    keywords: ["money", "coins-outline", "cashback", "allowance"],
  },
  ...
  { name: "plant-outline", keywords: ["garden", "home", "eco", "green"] },
  ...
  { name: "paw-print-outline", keywords: ["pet", "animal", "cat", "dog"] },
